	...
	public class CategoryManager : ICategoryService
	{
		...
		public async Task<IDataResult<CategoryDto>> Delete(int categoryId, string modifiedByName)
		{
			...
			if (category != null)
			{
				...
				await _unitOfWork.SaveAsync();
				return new DataResult<CategoryDto>(ResultStatus.Success, $"{deletedCategory.Name} adlı kategori başarılı bir şekilde silinmiştir.", new CategoryDto
				{
		...
		public async Task<IResult> HardDelete(int categoryId)
		{
			...
			if (category != null)
			{
				...
				await _unitOfWork.SaveAsync();
				return new Result(ResultStatus.Success, $"{category.Name} adlı kategori başarılı bir şekilde veritabınından silinmiştir.");
			}
